...
public class CourseController {
    ...
    public List<Course> putCurso(@PathVariable("name") String name, @RequestBody Course course) {
        return course.putCourse(name, course.getName(), course.getDuration(), course.getCost(), course.getAbility());
    }
}
